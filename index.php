...
<br />
<ul>
<li>Java e suas tecnologias (JSF e Spring) em nível intermediário;</li> 
<br />
<li>PHP em nível básico;</li>
<br />
<li>Linguagem de formatação para web (HTML e CSS) em nível intermediário;</li>
<br />
<li>Banco de dados (Oracle e MySQL) em nível básico;</li>
<br />
</ul>
...
<p id="paragrafo">Estudo e utilizo a linguagem JAVA como linguagem padrão para desenvolvimento, tanto de aplicações simples, que não requer nenhum conhecimento específico e de banco de dados, quanto aplicações Web, que requer um nível maior de conhecimento específico da linguagem e a integração com bancos de dados e utilização de frameworks de desenvolvimento.</p>
<p id="paragrafo">Atualmente, atuo como Analista de Suporte na empresa Camisaria Colombo, grupo este que completou 100 anos de existência, se consolidando como uma das maiores empresas do ramo varejista.</p>
</div>
</div>
</div>
</section>
...
<br />
<p id="paragrafo">Neste projeto, decidi desenvolver esta página, com o intuito de aplicar os conhecimentos adquiridos ao longo dos anos de estudo e aplicar novos conceitos e práticas de desenvolvimento.
<br />
